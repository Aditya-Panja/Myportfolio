      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Hi everyone! I’m <span className="purple">Aditya Panja</span>{" "}
            from <span className="purple">Kolakata, India</span>.
            <br />
            I’m currently pursing {" "}
            <span className="purple">MCA</span> at{" "}
            from {" "}
            ...
            <span className="purple">Calcutta University</span>.
            <br />
            <br />
